...
//#ADD SHAPED
  ...
  recipes.addShaped("immersivepetroleum_misc/drill_lube_alt", <immersiveengineering:toolupgrade:1>, [[<ore:craftingToolMediumHammer>.transformDamage(), <tfc:metal/ingot/wrought_iron>, null], [<tfc:metal/ingot/wrought_iron>, null, <tfc:metal/ingot/wrought_iron>], [null, <tfc:metal/ingot/wrought_iron>, <immersiveengineering:material:8>]]);
