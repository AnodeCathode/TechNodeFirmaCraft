...
// ================================================================================
//#ADD SHAPED
  recipes.addShaped("tnfc_firstaid_bandage", <firstaid:bandage> * 8, [[<ore:string>, <tfc:plants/porcini>, <ore:string>], [<ore:fabricHemp>, <ore:fabricHemp>, <ore:fabricHemp>], [<ore:string>, <tfc:plants/porcini>, <ore:string>]]);
  recipes.addShaped("tnfc_firstaid_plaster", <firstaid:plaster> * 4, [[<ore:string>, <ore:string>], [<ore:fabricHemp>,<tfc:plants/porcini>]]);
