...
//#ADD SHAPED
  ...
  recipes.addShaped("engineersworkshop_upgrade_autocrafter", <engineersworkshop:upgrade:1>, [[<ore:plankWood>, <ore:plankWood>, <ore:plankWood>], [<ore:stone>, <minecraft:piston>, <ore:stone>], [<ore:craftingToolMediumChisel>.transformDamage(), <engineersworkshop:upgrade>, <ore:craftingToolHammer>.transformDamage()]]);
	...
	recipes.addShaped("engineersworkshop_upgrade_queuing", <engineersworkshop:upgrade:5>, [[<ore:plankWood>, <ore:craftingToolMediumHammer>, <ore:plankWood>], [<ore:sheetIron>, <engineersworkshop:upgrade>, <ore:sheetIron>], [<ore:plankWood>, <ore:craftingToolMediumChisel>.transformDamage(), <ore:plankWood>]]);
