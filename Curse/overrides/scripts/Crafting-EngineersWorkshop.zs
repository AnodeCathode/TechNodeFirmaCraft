...
//#ADD SHAPED
  ...
  recipes.addShaped("engineersworkshop_upgrade_autocrafter", <engineersworkshop:upgrade:1>, [[<ore:plankWood>, <ore:plankWood>, <ore:plankWood>], [<ore:stone>, <minecraft:piston>, <ore:stone>], [<ore:craftingToolMediumChisel>, <engineersworkshop:upgrade>, <ore:craftingToolHammer>]]);
	recipes.addShaped("engineersworkshop_upgrade_storage", <engineersworkshop:upgrade:2>, [[<ore:chestWood>, <ore:craftingToolSaw>], [<engineersworkshop:upgrade>, null]]);
	recipes.addShaped("engineersworkshop_upgrade_charger", <engineersworkshop:upgrade:3>, [[null, <ore:dustRedstone>, null], [<ore:sheetAnyBronze>, <engineersworkshop:upgrade>, <ore:sheetAnyBronze>], [<ore:craftingToolMediumChisel>, <ore:dustRedstone>, <ore:craftingToolHammer>]]);
	recipes.addShaped("engineersworkshop_upgrade_speed", <engineersworkshop:upgrade:4>, [[<ore:sheetIron>, <ore:dustRedstone>, <ore:sheetIron>], [<ore:gemLapis>, <engineersworkshop:upgrade>, <ore:gemLapis>], [<ore:craftingToolMediumChisel>, <ore:dustRedstone>, <ore:craftingToolHammer>]]);
	recipes.addShaped("engineersworkshop_upgrade_queuing", <engineersworkshop:upgrade:5>, [[<ore:plankWood>, <ore:craftingToolMediumHammer>, <ore:plankWood>], [<ore:sheetIron>, <engineersworkshop:upgrade>, <ore:sheetIron>], [<ore:plankWood>, <ore:craftingToolMediumChisel>, <ore:plankWood>]]);
	recipes.addShaped("engineersworkshop_upgrade_autotransfer", <engineersworkshop:upgrade:6>, [[<ore:stone>, <ore:stone>, <ore:stone>], [<minecraft:hopper>, <ore:dustRedstone>, <minecraft:hopper>], [<ore:craftingToolMediumChisel>, <engineersworkshop:upgrade>, <ore:craftingToolHammer>]]);
	recipes.addShaped("engineersworkshop_upgrade7_filter", <engineersworkshop:upgrade:7>, [[<ore:stone>, <ore:sheetBlackSteel>, <ore:stone>], [<ore:sheetDoubleGold>, <minecraft:iron_bars>, <ore:sheetDoubleGold>], [<ore:craftingToolMediumChisel>, <engineersworkshop:upgrade>, <ore:craftingToolHammer>]]);
	recipes.addShaped("engineersworkshop_upgrade8_capacity", <engineersworkshop:upgrade:8>, [[<ore:sheetSteel>, <ore:stone>, <ore:sheetSteel>], [<ore:sheetDoubleGold>, <ore:blockRedstone>, <ore:sheetDoubleGold>], [<ore:craftingToolMediumChisel>, <engineersworkshop:upgrade>, <ore:craftingToolHammer>]]);
