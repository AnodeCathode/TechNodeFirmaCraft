...
//#ADD SHAPED
  ...
  recipes.addShaped("yabba_upgrade/blank", <yabba:upgrade_blank> * 16, [[<ore:slabWood> , <ore:slabStone>, <ore:slabWood> ], [<ore:paper>, <ore:chestWood>, <ore:paper>], [<ore:slabWood> , <ore:slabStone>, <ore:slabWood>]]);
