...
//#ADD SHAPED
  ...
  recipes.addShaped("tnfc_reinforced_ingot_pattern", <rockhounding_chemistry:ingot_pattern>.withTag({ench: [{lvl: 32766 as short, id: 34}], HideFlags:1, display: {Name: "Reinforced Ingot Mold Pattern"}}), [[<rockhounding_chemistry:ingot_pattern>, <rockhounding_chemistry:alloy_items_gems:7>, <rockhounding_chemistry:ingot_pattern>], [<rockhounding_chemistry:didymium_glass>, <rockhounding_chemistry:alloy_blocks_tech:14>, <rockhounding_chemistry:didymium_glass>], [<rockhounding_chemistry:ingot_pattern>, <rockhounding_chemistry:alloy_items_gems:1>, <rockhounding_chemistry:ingot_pattern>]]);
