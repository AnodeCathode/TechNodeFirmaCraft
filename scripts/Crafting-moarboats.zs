...
recipes.addShaped("moarboats_chunk_loader", <moarboats:chunk_loader>, [[null, <ore:gemExquisite>, null], [<ore:gangueAll>, <ore:gearRedSteel> | <ore:gearBlueSteel>, <ore:gangueAll>], [<ore:gangueAll>], [<pneumaticcraft:compressed_iron_block>, <tfc:metal/double_sheet/blue_steel>, <pneumaticcraft:compressed_iron_block>]]);
...
recipes.addShapeless("moarboats_dyedboat110", <moarboats:modular_boat:11> ,[<moarboats:modular_boat:*>, <tfc:wooden_bucket>.withTag({Fluid: {FluidName: "blue_dye", Amount: 1000}})]);
